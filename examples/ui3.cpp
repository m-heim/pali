...
int main(int argc, char **argv) {
  ...
  auto so4 = std::make_unique<FrameObject>(FrameObject(Point(10, 10), 10, 10, RGB(131, 131, 131), true));
  auto so5 = std::make_unique<StringObject>(StringObject(Point(4, 4), "Hello world", RGB(255, 255, 255), RGB(0, 0, 0)));
  auto so6 = std::make_unique<SnowObject>(SnowObject(Point(1, 1), PixelProperties("o", RGB(255, 255, 255), RGB(0, 0, 0)), 3, 0, 1));
